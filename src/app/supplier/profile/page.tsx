    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="container mx-auto max-w-4xl px-6 py-8">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button onClick={() => setIsPasswordDialogOpen(true)} variant="outline" className="border-zinc-800 sm:w-auto">
      ...
      <Dialog open={isPasswordDialogOpen} onOpenChange={setIsPasswordDialogOpen}>
        <DialogContent className="border-zinc-800 bg-zinc-950 text-zinc-100">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="ghost" onClick={() => setIsPasswordDialogOpen(false)} className="text-zinc-300 hover:text-white">
                Cancel
              </Button>
