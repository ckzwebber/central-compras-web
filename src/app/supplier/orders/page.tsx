      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex gap-2">
            <Button variant={filterStatus === "all" ? "default" : "outline"} onClick={() => setFilterStatus("all")} className={filterStatus !== "all" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              All
            </Button>
            <Button variant={filterStatus === "pending" ? "default" : "outline"} onClick={() => setFilterStatus("pending")} className={filterStatus !== "pending" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              Pending
            </Button>
            <Button
              variant={filterStatus === "processing" ? "default" : "outline"}
              onClick={() => setFilterStatus("processing")}
              className={filterStatus !== "processing" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              Processing
            </Button>
            <Button variant={filterStatus === "shipped" ? "default" : "outline"} onClick={() => setFilterStatus("shipped")} className={filterStatus !== "shipped" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              Shipped
            </Button>
          </div>
        </div>
                ...
                <Card key={order.id} className="border-zinc-800 bg-zinc-950/80 transition hover:border-zinc-700 hover:bg-zinc-900/60">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between gap-4">
                      ...
                      {/* Actions */}
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => setSelectedOrder(order)} className="border-zinc-800 text-zinc-300 hover:text-white">
