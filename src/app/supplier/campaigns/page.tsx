      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex gap-2">
            ...
            <Button variant={filterStatus === "active" ? "default" : "outline"} onClick={() => setFilterStatus("active")} className={filterStatus !== "active" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              Active
            </Button>
            <Button
              variant={filterStatus === "inactive" ? "default" : "outline"}
              onClick={() => setFilterStatus("inactive")}
              className={filterStatus !== "inactive" ? "border-zinc-800 text-zinc-300 hover:text-white" : ""}>
              Inactive
            </Button>
          </div>
        </div>
