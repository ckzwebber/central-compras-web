                ...
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" onClick={() => handleOpenDialog(term)} className="h-8 w-8 text-zinc-400 hover:text-white">
      ...
      <Dialog open={isDialogOpen} onOpenChange={handleCloseDialog}>
        <DialogContent className="border-zinc-800 bg-zinc-950 text-zinc-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="button" variant="ghost" onClick={handleCloseDialog} className="text-zinc-300 hover:text-white">
                Cancel
              </Button>
