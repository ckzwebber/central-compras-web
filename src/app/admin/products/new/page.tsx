...
const mockSuppliers: Supplier[] = [
  { id: "1", nomeFantasia: "Tech Distribuidora" },
  { id: "2", nomeFantasia: "Office Solutions" },
  { id: "3", nomeFantasia: "Importadora Global" },
];
      ...
      <div className="container mx-auto max-w-4xl px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3">
            <Button type="button" variant="ghost" onClick={() => router.push("/admin/products")} className="text-zinc-300 hover:text-white">
              Cancel
            </Button>
