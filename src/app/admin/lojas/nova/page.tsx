          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button type="button" variant="outline" size="icon" className="border-zinc-800" onClick={() => copyToClipboard(credentialsDialog.email, "email")}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button type="button" variant="outline" size="icon" className="border-zinc-800" onClick={() => copyToClipboard(credentialsDialog.password, "password")}>
